...
import { characterAPI, inventoryAPI, monsterAPI, InventoryItem, Monster, armyAPI, battleAPI, Army, Battle, BattleParticipant, skillAPI, Skill, beastAPI, Beast } from '../services/api';
...
const CampaignView: React.FC = () => {
  ...
  }, [campaignTab, currentCampaign, loadCharacterSkills, loadEquippedItems, loadEquipmentDetails, campaignName, loadCampaign, refreshActiveBattle, selectedCharacter, user]);
